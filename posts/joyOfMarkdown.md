...
author: Nobody Cares
summary:  tips and gotcha's about markdown.  A goal--  learn enough about markdown, to see if I could adopt an approach to web pages, where I use markdown files for the content (mostly text), and rely on the web page programming to do the layout and format.
tags:
  - programming
---
#####
